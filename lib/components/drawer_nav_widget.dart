...
import '../main_projects_web/main_projects_web_widget.dart';
import '../main_team_page/main_team_page_widget.dart';
import '../main_tracker/main_tracker_widget.dart';
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => MainTrackerWidget(),
                            ),
                          );
                        },
                        child: Row(
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => MainProjectsWebWidget(),
                            ),
                          );
                        },
                        child: Row(
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => MainTeamPageWidget(),
                            ),
                          );
                        },
                        child: Row(
